...
public class WordNet {
    ...
    public WordNet(String synsets, String hypernyms) {
        ...
        Digraph hypernym = new Digraph(count);
        while (inhyp.hasNextLine()) {
            String[] relation = inhyp.readLine().split(",");
            int hypo = Integer.parseInt(relation[0]);
        ...
        if (cycle.hasCycle())
            throw new IllegalArgumentException("The given graph forms a directed cyclic graph.");
